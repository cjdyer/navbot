...
namespace GPIO
{
    ...
    uint32_t sys_tick();
    void pwm_init();
    void pwm_start(PI_PWM_CHANNEL channel);
    ...
    static constexpr uint32_t vir_dma_base_address = 0x3EBF2000;
    static constexpr uint32_t vir_dma_len          = 0x00001000;
    static constexpr uint32_t bus_dma_base_address = 0xFEBF2000;
